...
c*********************************************************************
      ...
      double precision twod,factor(n)
      character(50) word
      character(2) rankno(10)
      data itimes /0/
...
c allowed percent variation
      ...
      do i=1,n
         factor(i)=factor(i)*2.0d0
      y(i)=s(i)+(factor(i)*(x(i)-0.5d0)*s(i))
      end do
      ...
      word(5:)=rankno(myrank+1)
         ...
         do i=1,3
         read(12,*)septs(i)
         if(i.lt.3)septs(i)=septs(i)*100.0d0
         end do
         close(12)


         word(1:3)='ip.'
         word(4:)=rankno(myrank+1)

          open(unit=34,file=word)
          read(34,*)septs(4)
          read(34,*)ea
          close(34)
            ...
            value=0.0d0
            if(ea.lt.2.0d0)value=1000.0d0
           do  i=1,ndata
           value=value+ ( septs(i)-ab(i) )**2 
          end do
          print*,value
           value=1.0d0/value
      ...
      word(1:11)='PARAMETERS.'
      word(12:)=rankno(myrank+1)

      OPEN(UNIT=11,FILE=word)
      rewind 11
      WRITE(11,*)'UPP        90  ',Y(1)
      WRITE(11,*)'BETAP      90  ',Y(2)
      WRITE(11,*)'ZP         90  ',Y(3)
      WRITE(11,*)'GPP        90  ',Y(4)
      WRITE(11,*)'GSP        90  ',Y(5)
      WRITE(11,*)'HSP        90  ',Y(6)
      WRITE(11,*)'GP2        90  ',Y(4)*.85D0
      WRITE(11,*)'UDD        92  ',Y(7)
      WRITE(11,*)'BETAD      92  ',Y(8)
      WRITE(11,*)'ZD         92  ',Y(9)
      WRITE(11,*)'ZSN        92  ',Y(10)
      WRITE(11,*)'ZPN        92  ',Y(11)
      WRITE(11,*)'ZDN        92  ',Y(12)
      WRITE(11,*)'ALPHA        90  ',Y(13)
      WRITE(11,*)'ALPHA        92  ',Y(14)
      ...
      END
            ...
            subroutine evalf(f,Y,n,ab,septs,npts,istop)
      implicit double precision (a-h,o-z)
      DOUBLE PRECISION f,fold,Y(n),ab(npts),septs(npts)
      integer npts
      data fold /1.0D20/
      if(abs(f).lt.abs(fold))then
      open(unit=11,file='lowest-so-far')
      rewind 11
      write(11,*)'lowest f so far is',f
      WRITE(11,*)'UPP        90  ',Y(1)
      WRITE(11,*)'BETAP      90  ',Y(2)
      WRITE(11,*)'ZP         90  ',Y(3)
      WRITE(11,*)'GPP        90  ',Y(4)
      ...
      do i=1,npts
      write(11,*)i,'|',septs(i),'|',ab(i)
      end do
 23            format(i2,f10.7,f10.7)
      close(11)
      OPEN(UNIT=40,FILE='RESTART')
      WRITE(40,*)Y
      CLOSE(40)
      fold=f
      end if
      ...
      if(f.lt.1.0)then
      print*,'stoppin cuz f is small enough in evalf',f
      istop=1
      end if
